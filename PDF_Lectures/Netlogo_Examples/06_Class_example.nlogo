...
if scenario = "scenario 4"
  [ask patch 1 1 [set water? true set pcolor blue]]
  ...
  ask one-of turtles [set sex "male" set color yellow move-to patch 1 2]

  if scenario = "scenario 1"
  [ask patch 1 1 [set water? true set pcolor blue]]

  if scenario = "scenario 2"
  [ask patch 4 2 [set water? true set pcolor blue]]

  if scenario = "scenario 3"
  [ask n-of 2 patches [set water? true set pcolor blue]]



;  set foo turtles with [color = yellow]
;  print foo
;  show count foo
...
to go
  if breeding-season?
  [
    ask turtles [move-to one-of patches with [water? = true]]
  ]
...
to collectives
  ca
  create-mice 50
  ask mice [ set color white setxy random-xcor random-ycor]
  create-frogs 50
  ask frogs [ set color green setxy random-xcor random-ycor]
